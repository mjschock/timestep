...
local_resource(
    ...
    deps=[
        ...
        'src/timestep/infra/stacks/k3s_cluster/cloud_init_config/construct.py',
        'src/timestep/infra/stacks/k3s_cluster/cloud_instance/construct.py',
        'src/timestep/infra/stacks/k3s_cluster/cloud_instance_domain/construct.py',
        'src/timestep/infra/stacks/k3s_cluster/domain_name_registrar/construct.py',
        'src/timestep/infra/stacks/k3s_cluster/kube_config/construct.py',
        'src/timestep/infra/stacks/kubernetes_config/stack.py',
        'src/timestep/infra/stacks/kubernetes_config/kubeapps/construct.py',
        'src/timestep/infra/stacks/kubernetes_config/argo_cd/construct.py',
        'src/timestep/infra/stacks/kubernetes_config/kubeapps/construct.py',
        'src/timestep/infra/stacks/kubernetes_config/kubernetes_cluster_ingress/construct.py',
        'src/timestep/infra/stacks/kubernetes_config/kubernetes_dashboard/construct.py',
        'src/timestep/infra/stacks/kubernetes_config/minio/construct.py',
        'src/timestep/infra/stacks/kubernetes_config/postgresql/construct.py',
        'src/timestep/infra/stacks/kubernetes_config/prefect/construct.py',
        'src/timestep/infra/stacks/kubernetes_config/registry/construct.py',
        'src/timestep/infra/stacks/kubernetes_config/sealed_secrets/construct.py',
