...
k3s-cluster:
	k3sup install --context $PRIMARY_DOMAIN_NAME --ip 10.159.189.181 --k3s-extra-args '--disable traefik' --local-path kubeconfig --merge --ssh-key ./.ssh/id_ed25519 --user ubuntu
