...
agents:
	...
	poetry new --name=timestep.agents.agent --src src/timestep/agents/agent || true
	poetry add -e src/timestep/agents/agent
...
envs:
	poetry new --name=timestep.envs.env --src src/timestep/envs/env || true
	poetry add -e src/timestep/envs/env
	...
	poetry new --name=timestep.envs.turtle_sim --src src/timestep/envs/turtle_sim || true
	poetry add -e src/timestep/envs/turtle_sim
