...
def test_download_agent_task_artifact():
    response = client.get(
...
def test_execute_agent_task_step():
    response = client.post(
...
def test_list_agent_task_artifacts():
    response = client.get(
...
def test_list_agent_task_steps():
    response = client.get(
...
def test_upload_agent_task_artifacts():
    response = client.post(
