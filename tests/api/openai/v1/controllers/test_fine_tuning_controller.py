...
def test_cancel_fine_tuning_job():
...
def test_create_fine_tuning_job():
    response = client.post(
...
def test_list_fine_tuning_events():
    response = client.get(
...
def test_list_fine_tuning_job_checkpoints():
    response = client.get(
...
def test_list_paginated_fine_tuning_jobs():
    response = client.get(
