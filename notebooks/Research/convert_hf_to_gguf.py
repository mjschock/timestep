...
class LlamaModel(Model):
    ...
    def modify_tensors(self, data_torch: Tensor, name: str, bid: int | None) -> Iterable[tuple[str, Tensor]]:
        print(f'=== modify_tensors (name={name})')
        print(f"tensor_names: ", self.tensor_names)
        print(f"self.map_tensor_name: ", self.map_tensor_name)

        if name in (
            "freqs_cis",
            "layers.0.attention.cache_kv",
            "layers.1.attention.cache_kv",
            "layers.2.attention.cache_kv",
            "layers.3.attention.cache_kv",
            "layers.4.attention.cache_kv",
            "layers.5.attention.cache_kv",
            "layers.6.attention.cache_kv",
            "layers.7.attention.cache_kv",
            "layers.8.attention.cache_kv",
            "layers.9.attention.cache_kv",
            "layers.10.attention.cache_kv",
            "layers.11.attention.cache_kv",
            "layers.12.attention.cache_kv",
            "layers.13.attention.cache_kv",
            "layers.14.attention.cache_kv",
            "layers.15.attention.cache_kv",
            "layers.16.attention.cache_kv",
            "layers.17.attention.cache_kv",
            "layers.18.attention.cache_kv",
            "layers.19.attention.cache_kv",
            "layers.20.attention.cache_kv",
            "layers.21.attention.cache_kv",
            "tok_embeddings.arange",
        ):
            return []
