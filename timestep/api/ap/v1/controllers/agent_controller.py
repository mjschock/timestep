...
def create_agent_task(task_request_body=None):  # noqa: E501
    ...
    if connexion.request.is_json:
        task_request_body = TaskRequestBody.from_dict(connexion.request.get_json())  # noqa: E501
...
def execute_agent_task_step(task_id, step_request_body=None):  # noqa: E501
    ...
    """
    if connexion.request.is_json:
        step_request_body = StepRequestBody.from_dict(connexion.request.get_json())  # noqa: E501
    raise NotImplementedError
