...
from llama_index.llms import CustomLLM, HuggingFaceLLM, MockLLM, OpenAI, OpenAILike
...
def get_agent(init_task_state_kwargs: Optional[Dict[str, Any]] = None) -> AgentRunner:
    ...
    tools = [add_tool, divide_tool, multiply_tool]
    ...
    multi_modal_react_agent_worker: MultimodalReActAgentWorker = MultimodalReActAgentWorker.from_tools(
        tools,
