...
from agent_protocol import Artifact, Step, TaskDB
...
from multi_modal import HuggingFaceMultiModalLLM
...
class Agent:
    ...
    def reset(self, seed: int = 42):
        ...
        # checkpoint="Vision-CAIR/MiniGPT-4"
        checkpoint = "bigcode/starcoder"
        # tokenizer = AutoTokenizer.from_pretrained(checkpoint)
        # tokenizer.pad_token = tokenizer.eos_token # https://huggingface.co/docs/transformers/main/llm_tutorial#common-pitfalls
        # set_global_tokenizer(tokenizer.encode) # https://docs.llamaindex.ai/en/stable/module_guides/models/llms.html#a-note-on-tokenization
        ...
        multi_modal_llm = HuggingFaceMultiModalLLM(
