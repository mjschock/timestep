    ...
    <div class="q-pa-md" style="max-width: 400px">
      ...
      >
        ...
        <div>
          ...
          <q-btn label="Sign in" color="primary" type="button" @click="signIn()" />
          <q-btn label="Sign up" color="primary" type="button" @click="signUp()" />
          <!-- <q-btn label="Reset" type="reset" color="primary" /> -->
          <q-btn label="Resend verification email?" color="primary" type="button" @click="sendVerificationEmail()" />
        </div>
      </q-form>
      ...
      >
        <q-btn v-if="submitResult.error == 'invalid-email-password'" label="Reset password?" color="primary" type="button" @click="resetPassword()" />
...
import { AuthErrorPayload, Mfa, NhostClient, NhostSession, NhostSessionResponse, ResetPasswordParams, ResetPasswordResponse, SendVerificationEmailParams, SendVerificationEmailResponse, SignInParams, SignInResponse, SignUpParams } from '@nhost/nhost-js'
import { type } from 'os'
