...
class DataDigitaloceanProjects(
    ...
    def __init__(
        ...
        *,
        ...
        :param filter: filter block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.29.0/docs/data-sources/projects#filter DataDigitaloceanProjects#filter}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.29.0/docs/data-sources/projects#id DataDigitaloceanProjects#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param sort: sort block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.29.0/docs/data-sources/projects#sort DataDigitaloceanProjects#sort}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
...
@jsii.data_type(
    jsii_type="digitalocean.dataDigitaloceanProjects.DataDigitaloceanProjectsConfig",
...
@jsii.data_type(
    jsii_type="digitalocean.dataDigitaloceanProjects.DataDigitaloceanProjectsFilter",
    jsii_struct_bases=[],
    name_mapping={
        "key": "key",
        "values": "values",
...
class DataDigitaloceanProjectsFilter:
    def __init__(
        ...
        *,
        ...
        '''
        :param key: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.29.0/docs/data-sources/projects#key DataDigitaloceanProjects#key}.
        :param values: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.29.0/docs/data-sources/projects#values DataDigitaloceanProjects#values}.
        :param all: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.29.0/docs/data-sources/projects#all DataDigitaloceanProjects#all}.
        :param match_by: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.29.0/docs/data-sources/projects#match_by DataDigitaloceanProjects#match_by}.
        '''
        if __debug__:
...
class DataDigitaloceanProjectsFilterList(
    ...
    metaclass=jsii.JSIIMeta,
    jsii_type="digitalocean.dataDigitaloceanProjects.DataDigitaloceanProjectsFilterList",
):
    def __init__(
        self,
...
class DataDigitaloceanProjectsFilterOutputReference(
    ...
    metaclass=jsii.JSIIMeta,
    jsii_type="digitalocean.dataDigitaloceanProjects.DataDigitaloceanProjectsFilterOutputReference",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="digitalocean.dataDigitaloceanProjects.DataDigitaloceanProjectsProjects",
    jsii_struct_bases=[],
    name_mapping={},
)
...
class DataDigitaloceanProjectsProjectsList(
    _cdktf_9a9027ec.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="digitalocean.dataDigitaloceanProjects.DataDigitaloceanProjectsProjectsList",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
...
class DataDigitaloceanProjectsProjectsOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="digitalocean.dataDigitaloceanProjects.DataDigitaloceanProjectsProjectsOutputReference",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="digitalocean.dataDigitaloceanProjects.DataDigitaloceanProjectsSort",
    jsii_struct_bases=[],
...
class DataDigitaloceanProjectsSort:
    def __init__(
        ...
        *,
        ...
        '''
        :param key: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.29.0/docs/data-sources/projects#key DataDigitaloceanProjects#key}.
        :param direction: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.29.0/docs/data-sources/projects#direction DataDigitaloceanProjects#direction}.
        '''
        if __debug__:
...
class DataDigitaloceanProjectsSortList(
    _cdktf_9a9027ec.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="digitalocean.dataDigitaloceanProjects.DataDigitaloceanProjectsSortList",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
...
class DataDigitaloceanProjectsSortOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="digitalocean.dataDigitaloceanProjects.DataDigitaloceanProjectsSortOutputReference",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
