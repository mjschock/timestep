...
class UptimeCheck(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: A human-friendly display name for the check. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.29.0/docs/resources/uptime_check#name UptimeCheck#name}
        :param target: The endpoint to perform healthchecks on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.29.0/docs/resources/uptime_check#target UptimeCheck#target}
        :param enabled: A boolean value indicating whether the check is enabled/disabled. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.29.0/docs/resources/uptime_check#enabled UptimeCheck#enabled}
        :param regions: An array containing the selected regions to perform healthchecks from. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.29.0/docs/resources/uptime_check#regions UptimeCheck#regions}
        :param type: The type of health check to perform. Enum: 'ping' 'http' 'https'. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.29.0/docs/resources/uptime_check#type UptimeCheck#type}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
