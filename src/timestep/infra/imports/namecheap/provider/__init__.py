...
class NamecheapProvider(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__0e8296e4cd4ed43ef2fb357d86c488288a909c4655223c3ace96996d1483bf59
            )
            check_type(
    ...
    def api_user_input(self) -> typing.Optional[builtins.str]:
        return typing.cast(
            typing.Optional[builtins.str], jsii.get(self, "apiUserInput")
        )
    ...
    def client_ip_input(self) -> typing.Optional[builtins.str]:
        return typing.cast(
            typing.Optional[builtins.str], jsii.get(self, "clientIpInput")
        )
    ...
    def alias(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__c853e2215e5e4193e0e779bd5cad7b563dad9b076879d4b15ce0f8241418bb66
            )
            check_type(
    ...
    def api_key(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__3b2844e4214d768a5c6c2a3f0d1890d15b5d175a5a9718249246ef32ed1c3664
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def api_user(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__0bda5570cd10f30f90fdd3e8431c717ebf719eaf30cc57d477ddc2af49606eef
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def client_ip(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__2ad1fa9574e708be6128b8fd15481e16b84292270569b5da851a26f3d839d27b
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def user_name(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__bccefd916ae5a0e785a449f0d7c1796c5fb3a8b9343ade511cd7ceb2a3083ac5
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def use_sandbox(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__8a1902c95ed0e4284ef571896b023f7a0ab2f66adaf2cd17c07ce0464a9daf82
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NamecheapProviderConfig:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__2bbe67cb9997df680cfc0ead837d5c20cf2b21da7a92e63a090950d3fc9bc5d9
            )
            check_type(
            ...
            check_type(
                argname="argument api_user",
                value=api_user,
                expected_type=type_hints["api_user"],
            )
            check_type(
            ...
            check_type(
                argname="argument use_sandbox",
                value=use_sandbox,
                expected_type=type_hints["use_sandbox"],
            )
