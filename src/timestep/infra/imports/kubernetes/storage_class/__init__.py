...
class StorageClass(
    ...
    def __init__(
        ...
        *,
        metadata: typing.Union[
            "StorageClassMetadata", typing.Dict[builtins.str, typing.Any]
        ],
        storage_provisioner: builtins.str,
        allowed_topologies: typing.Optional[
            typing.Union[
                "StorageClassAllowedTopologies", typing.Dict[builtins.str, typing.Any]
            ]
        ] = None,
        ...
        """Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/storage_class kubernetes_storage_class} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param metadata: metadata block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/storage_class#metadata StorageClass#metadata}
        :param storage_provisioner: Indicates the type of the provisioner. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/storage_class#storage_provisioner StorageClass#storage_provisioner}
        :param allowed_topologies: allowed_topologies block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/storage_class#allowed_topologies StorageClass#allowed_topologies}
        :param allow_volume_expansion: Indicates whether the storage class allow volume expand. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/storage_class#allow_volume_expansion StorageClass#allow_volume_expansion}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/storage_class#id StorageClass#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param mount_options: Persistent Volumes that are dynamically created by a storage class will have the mount options specified. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/storage_class#mount_options StorageClass#mount_options}
        :param parameters: The parameters for the provisioner that should create volumes of this storage class. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/storage_class#parameters StorageClass#parameters}
        :param reclaim_policy: Indicates the type of the reclaim policy. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/storage_class#reclaim_policy StorageClass#reclaim_policy}
        :param volume_binding_mode: Indicates when volume binding and dynamic provisioning should occur. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/storage_class#volume_binding_mode StorageClass#volume_binding_mode}
        :param connection:
        :param count:
        :param depends_on:
        :param for_each:
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__c527d5dc254b1677e8b84e5a014b31a6b77ce8cd292692fb4adc8e254bc063d1
            )
            check_type(
    ...
    def put_allowed_topologies(
        ...
        *,
        ...
        """
        :param match_label_expressions: match_label_expressions block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/storage_class#match_label_expressions StorageClass#match_label_expressions}
        """
    ...
    def put_metadata(
        ...
        *,
        ...
        """
        :param annotations: An unstructured key value map stored with the storage class that may be used to store arbitrary metadata. More info: http://kubernetes.io/docs/user-guide/annotations Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/storage_class#annotations StorageClass#annotations}
        :param generate_name: Prefix, used by the server, to generate a unique name ONLY IF the ``name`` field has not been provided. This value will also be combined with a unique suffix. Read more: https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#idempotency Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/storage_class#generate_name StorageClass#generate_name}
        :param labels: Map of string keys and values that can be used to organize and categorize (scope and select) the storage class. May match selectors of replication controllers and services. More info: http://kubernetes.io/docs/user-guide/labels Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/storage_class#labels StorageClass#labels}
        :param name: Name of the storage class, must be unique. Cannot be updated. More info: http://kubernetes.io/docs/user-guide/identifiers#names. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/storage_class#name StorageClass#name}
        """
    ...
    def metadata(self) -> "StorageClassMetadataOutputReference":
        return typing.cast(
            "StorageClassMetadataOutputReference", jsii.get(self, "metadata")
        )
    ...
    def metadata_input(self) -> typing.Optional["StorageClassMetadata"]:
        return typing.cast(
            typing.Optional["StorageClassMetadata"], jsii.get(self, "metadataInput")
        )
    ...
    def allow_volume_expansion(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__bb675e657ac5d7f4c817785a08add3dbface0a42a0f1f364f6047c8a22b35f2e
            )
            check_type(
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__89bebf397bbf94e4d6432c2d42bc4cf1ab3271130e5cfec070739f48ac00251e
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def mount_options(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__49e3d2d4226f6215b0fb798945a0e797c3ac5fe32c36fad528d5a30e80984f34
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def parameters(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__1ba32567946fc43b6be3404a7624f2323f1fad2365a3d480735336bdb7f378db
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def reclaim_policy(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__b98e7cbe8c7836862ed85bf780445031fdd9d43eafd346463145bf3ea4f910c0
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def storage_provisioner(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__6f684b890144f49fcbab9388d791ebe1eee29c477063d81270d092aa868da356
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def volume_binding_mode(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__570db2399429854e2b89487370ba09b3387cb736c9ac47b539a2034c422986e6
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class StorageClassAllowedTopologies:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__99e527407ee35ead649fc1cfa88fb0f1af30c3b393a2618c7eb212df21f7a4da
            )
            check_type(
    ...
    def match_label_expressions(
        ...
        typing.Union[
            _cdktf_9a9027ec.IResolvable,
            typing.List["StorageClassAllowedTopologiesMatchLabelExpressions"],
        ]
    ]:
...
class StorageClassAllowedTopologiesMatchLabelExpressions:
    def __init__(
        ...
        *,
        ...
        """
        :param key: The label key that the selector applies to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/storage_class#key StorageClass#key}
        :param values: An array of string values. One value must match the label to be selected. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/storage_class#values StorageClass#values}
        """
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__4e312847f7d80531a2d77da48fcca28ffbe71eac47a472779bfedffde5a6a0a6
            )
            check_type(
...
class StorageClassAllowedTopologiesMatchLabelExpressionsList(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__316de985d95b9f914235b13d1905028c0333162e7b000dc269f7a28e3aff9e00
            )
            check_type(
    ...
    def get(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__0ebfbd05f021729154f254664dfdd0ff6fa57b04a4a8cb1cf53f0f6cd50e8fe6
            )
            check_type(
    ...
    def _terraform_attribute(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__f4a3c6cc67d999efa1bbda6e1c41663c44e3b308eccbf44589a9866b0ba54a60
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _terraform_resource(self, value: _cdktf_9a9027ec.IInterpolatingParent) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__2aed51c80e43ddcef77d7df2fbc80f97357392483d84939584d2c03b267d03a6
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _wraps_set(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__ccb7a534d4b3d9d32fd3a1a93dc34a1ed34b31ccf2fa4c5db95632d1ec15f68a
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__ba69602f2ee229dd3057a1ed67a2ff615c9581b06b951d9b76e31d9ed35416d8
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class StorageClassAllowedTopologiesMatchLabelExpressionsOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__330e1ffaad6a5127e53f9f000638435140f04ff7416bb0fd7273796b103a38dd
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def key(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__4d209dc883f2dada0dbb10213c9d90a08b683581aef9dad42af8d651462c3a8d
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def values(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__fb8eb7198e6f19c429fbb04d49d06f340b7181db01b9d32a1a62092cf871da26
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__2f827155873ad612e0baf45ef784b32060452d6b352994285e5bf7f22476f7c2
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class StorageClassAllowedTopologiesOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__35820cd209af3fc07ea9bdc9dfb39db61160a927a04148c049f4bca13fb967fd
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def put_match_label_expressions(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__97dbe59ab4170e2350d79112909f14ee7d020544bf7e81a5ef156fdad9d766bd
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__deb380fa1e84b30cbea1ec48bd2e8b106472eddf2ea1bc8729727a6c9fa42d37
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class StorageClassConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__43eb3a3a2d088ac858737edc63316672c52f104063e6d21e5ea34958f6143be3
            )
            check_type(
...
class StorageClassMetadata:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__e385fbf8a12003f83551e64de221499011400d6a832b1b2f1f91bf48a52ef9a5
            )
            check_type(
...
class StorageClassMetadataOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__9a5ec93ffb1df968940a9de5d9a511ec1c1eb85e6154a610bd80f3cda48b25d0
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def annotations(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__9cffc07d5c232c3e68d56f8505c5384f7a2ebaf3945d159f39858edd71c57024
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def generate_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__c6e42f0ea3a98b9366467b4072bce5c8de8bb2f0eb237ef2ea9c7644da65cf4a
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def labels(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__facd2859b9f34fe34c9c67237e11303180a8e39cfc855e11c039b1807725cbcf
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__be479615c4ab587d1b81f7163a96bda1502dd6977e221be81fb7e668722b3fde
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(self) -> typing.Optional[StorageClassMetadata]:
        return typing.cast(
            typing.Optional[StorageClassMetadata], jsii.get(self, "internalValue")
        )
    ...
    def internal_value(self, value: typing.Optional[StorageClassMetadata]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__9222a55baa5bcb92500e269ebf13957b5bdcf70ebf1ee3ef95505accbccde3ad
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
