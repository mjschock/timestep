...
class NetworkPolicy(
    ...
    def __init__(
        ...
        *,
        metadata: typing.Union[
            "NetworkPolicyMetadata", typing.Dict[builtins.str, typing.Any]
        ],
        ...
        :param metadata: metadata block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#metadata NetworkPolicy#metadata}
        :param spec: spec block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#spec NetworkPolicy#spec}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#id NetworkPolicy#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param connection:
        :param count:
        :param depends_on:
        :param for_each:
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__bb70000ddb33b80ba3f7674b72dd47f0c65214f158c49eab24878c55231abd76
            )
            check_type(
    ...
    def put_metadata(
        ...
        *,
        ...
        """
        :param annotations: An unstructured key value map stored with the network policy that may be used to store arbitrary metadata. More info: http://kubernetes.io/docs/user-guide/annotations Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#annotations NetworkPolicy#annotations}
        :param generate_name: Prefix, used by the server, to generate a unique name ONLY IF the ``name`` field has not been provided. This value will also be combined with a unique suffix. Read more: https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#idempotency Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#generate_name NetworkPolicy#generate_name}
        :param labels: Map of string keys and values that can be used to organize and categorize (scope and select) the network policy. May match selectors of replication controllers and services. More info: http://kubernetes.io/docs/user-guide/labels Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#labels NetworkPolicy#labels}
        :param name: Name of the network policy, must be unique. Cannot be updated. More info: http://kubernetes.io/docs/user-guide/identifiers#names. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#name NetworkPolicy#name}
        :param namespace: Namespace defines the space within which name of the network policy must be unique. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#namespace NetworkPolicy#namespace}
        """
    ...
    def put_spec(
        ...
        *,
        pod_selector: typing.Union[
            "NetworkPolicySpecPodSelector", typing.Dict[builtins.str, typing.Any]
        ],
        ...
        egress: typing.Optional[
            typing.Union[
                ...
                typing.Sequence[
                    typing.Union[
                        "NetworkPolicySpecEgress", typing.Dict[builtins.str, typing.Any]
                    ]
                ],
            ]
        ] = None,
        ...
        """
        :param pod_selector: pod_selector block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#pod_selector NetworkPolicy#pod_selector}
        :param policy_types: List of rule types that the NetworkPolicy relates to. Valid options are ["Ingress"], ["Egress"], or ["Ingress", "Egress"]. If this field is not specified, it will default based on the existence of Ingress or Egress rules; policies that contain an Egress section are assumed to affect Egress, and all policies (whether or not they contain an Ingress section) are assumed to affect Ingress. If you want to write an egress-only policy, you must explicitly specify policyTypes [ "Egress" ]. Likewise, if you want to write a policy that specifies that no egress is allowed, you must specify a policyTypes value that include "Egress" (since such a policy would not include an Egress section and would otherwise default to just [ "Ingress" ]). This field is beta-level in 1.8 Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#policy_types NetworkPolicy#policy_types}
        :param egress: egress block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#egress NetworkPolicy#egress}
        :param ingress: ingress block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#ingress NetworkPolicy#ingress}
        """
    ...
    def metadata(self) -> "NetworkPolicyMetadataOutputReference":
        return typing.cast(
            "NetworkPolicyMetadataOutputReference", jsii.get(self, "metadata")
        )
    ...
    def metadata_input(self) -> typing.Optional["NetworkPolicyMetadata"]:
        return typing.cast(
            typing.Optional["NetworkPolicyMetadata"], jsii.get(self, "metadataInput")
        )
    ...
    def spec_input(self) -> typing.Optional["NetworkPolicySpec"]:
        return typing.cast(
            typing.Optional["NetworkPolicySpec"], jsii.get(self, "specInput")
        )
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__2b42329c92b92728cfb45ea45169c37052694e935978395bfd6cf032aec163e0
            )
            check_type(
...
class NetworkPolicyConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__364d580af9bca8ec0980a71fe866bb13a46b94956144fa89e213c927f70b5429
            )
            check_type(
...
class NetworkPolicyMetadata:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__62e08969e357dac750417410309f456ebedd0b54300731729870f6d1db3f9eed
            )
            check_type(
...
class NetworkPolicyMetadataOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__292756ebbe59444150d2e20918adb3dd09ae5439d74fe64f1c41de04f5609ffb
            )
            check_type(
    ...
    def annotations(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__3f03ff2d5102c883f5d9ae1d976d6f27120f47bda59624b2e4915f20178d28d3
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def generate_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__052f634585d45a535b6d6188e783d3aea86eba99d66fac6450f2f1e595c8e90b
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def labels(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__6834811f787de60dc84c4b55506888d7ce2d216578b1ccbd3db40b890978c194
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__2d266d0dea6c19f4606331a90834ab3fb28926b269acc17a7f93445c5f33b3bd
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def namespace(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__82cf4c714a83d3150477f4f34be6fc9851f9d45f9f931805ccc4aa28ea03d456
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(self) -> typing.Optional[NetworkPolicyMetadata]:
        return typing.cast(
            typing.Optional[NetworkPolicyMetadata], jsii.get(self, "internalValue")
        )
    ...
    def internal_value(self, value: typing.Optional[NetworkPolicyMetadata]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__8f7b23eccd76b9b5bbb7a831451f64fad6542cfb2fe489068e15205e0ade490d
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpec:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__9f1cbfe69c5a56ba339d66992f3d44a0a2a905d91a28ed6d687662558198e149
            )
            check_type(
    ...
    def egress(
        ...
        typing.Union[
            _cdktf_9a9027ec.IResolvable, typing.List["NetworkPolicySpecEgress"]
        ]
    ]:
        """egress block.
    ...
    def ingress(
        ...
        typing.Union[
            _cdktf_9a9027ec.IResolvable, typing.List["NetworkPolicySpecIngress"]
        ]
    ]:
        """ingress block.
...
class NetworkPolicySpecEgress:
    def __init__(
        ...
        *,
        ...
        """
        :param ports: ports block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#ports NetworkPolicy#ports}
        :param to: to block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#to NetworkPolicy#to}
        """
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__57766175b750e65b6a5b8bf1ad682472cd502608c90c7d39f7a7e2efad15def8
            )
            check_type(
    ...
    def ports(
        ...
        typing.Union[
            _cdktf_9a9027ec.IResolvable, typing.List["NetworkPolicySpecEgressPorts"]
        ]
    ]:
        """ports block.
        ...
        return typing.cast(
            typing.Optional[
                typing.Union[
                    _cdktf_9a9027ec.IResolvable,
                    typing.List["NetworkPolicySpecEgressPorts"],
                ]
            ],
            result,
        )
    ...
    def to(
        ...
        typing.Union[
            _cdktf_9a9027ec.IResolvable, typing.List["NetworkPolicySpecEgressTo"]
        ]
    ]:
        """to block.
        ...
        return typing.cast(
            typing.Optional[
                typing.Union[
                    _cdktf_9a9027ec.IResolvable,
                    typing.List["NetworkPolicySpecEgressTo"],
                ]
            ],
            result,
        )
...
class NetworkPolicySpecEgressList(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__8d8ae6bd9c71445993e674737cfcd2e126f3f7e5308b86b5739de843644b1e8a
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def get(self, index: jsii.Number) -> "NetworkPolicySpecEgressOutputReference":
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__82a20eadf4a463150a56cf34173e6ecea2df9f71f05dc1941dd04a9b58e8f31b
            )
            check_type(
                argname="argument index", value=index, expected_type=type_hints["index"]
            )
        return typing.cast(
            "NetworkPolicySpecEgressOutputReference", jsii.invoke(self, "get", [index])
        )
    ...
    def _terraform_attribute(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__58f51c902ca15e9320b6f4a3be0bd6ed1e5bf33cf71bb82e5a8bb7736dd5bd66
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _terraform_resource(self, value: _cdktf_9a9027ec.IInterpolatingParent) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__b9321bdf342fe12a28c529eb3322c3291977da6e846fdead1f74fad6f09dd082
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _wraps_set(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__249013366be3b4fe4460655450eca9d9f669f777d6ed118643ec824cc9d69014
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        typing.Union[_cdktf_9a9027ec.IResolvable, typing.List[NetworkPolicySpecEgress]]
    ]:
        return typing.cast(
            typing.Optional[
                typing.Union[
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__948a9cbcc08a249c4c8b145827696e5176acce4a3de1760d0dcbbf9ab55ba468
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecEgressOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__0845d446e4b9b796cfe448863461858d38a7772cec72d70d38b9a628fd20108d
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def put_ports(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__0a38d2f055b9e00ac84ecaa420a4e9a23162f83f4901992b095420f3875f26dd
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def put_to(
        ...
        value: typing.Union[
            ...
            typing.Sequence[
                typing.Union[
                    "NetworkPolicySpecEgressTo", typing.Dict[builtins.str, typing.Any]
                ]
            ],
        ],
    ) -> None:
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__0182c92aee65e0a9d94ba0f5ae341dc398f0ae73f21921c282cc79bc5099b9bd
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        typing.Union[_cdktf_9a9027ec.IResolvable, NetworkPolicySpecEgress]
    ]:
        return typing.cast(
            typing.Optional[
                typing.Union[_cdktf_9a9027ec.IResolvable, NetworkPolicySpecEgress]
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__651e3031691d0b96e0d23ebcee15184e2b8746c4aa07a1d9fff7bcb85c1af160
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecEgressPorts:
    def __init__(
        ...
        *,
        ...
        """
        :param port: The port on the given protocol. This can either be a numerical or named port on a pod. If this field is not provided, this matches all port names and numbers. If present, only traffic on the specified protocol AND port will be matched. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#port NetworkPolicy#port}
        :param protocol: The protocol (TCP, UDP, or SCTP) which traffic must match. If not specified, this field defaults to TCP. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#protocol NetworkPolicy#protocol}
        """
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__04fa0685b502202eb0d4ed5ac9c65009e1cefbf2daca9287b39f8fd22d42b17e
            )
            check_type(
...
class NetworkPolicySpecEgressPortsList(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__39ded4a339faf1240f9bf0c8ad9190b0e4be6b4309cb11ca1af48f61843b03ca
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def get(self, index: jsii.Number) -> "NetworkPolicySpecEgressPortsOutputReference":
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__e727643b3502d5cb3b43dc06e51a04a8b83f300a46c237a3d1889441f9d9b31d
            )
            check_type(
                argname="argument index", value=index, expected_type=type_hints["index"]
            )
    ...
    def _terraform_attribute(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__91439414725f2e3da93c8e23630adbae593241b5c025380cbbdcbf10c6a56e3d
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _terraform_resource(self, value: _cdktf_9a9027ec.IInterpolatingParent) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__2e854557fb4d5390bc26e17717a09424ffe1de9efc9c4294f19dfd7fdc6c1b80
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _wraps_set(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__ca667e96639f5bbc2a63c84e76adb16637e7cecf587aa803008c164371d693be
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__7af2cb091b4055397fd31cc5c792af87693fb6d7d8d1bea420df2bf393f46564
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecEgressPortsOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__c8b616fccd9d6aca09c3a1d3c3043ed18f897d71ca736d7a267d8f7649f96b05
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def port(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__27c4f15d1603d549600567645a222650520ed0d0bd180c8ec84843fd244fd166
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def protocol(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__473adc94bca0053c4bc18d6a4d2be6d272edcbacea2340fe7921ff4d50991a51
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        typing.Union[_cdktf_9a9027ec.IResolvable, NetworkPolicySpecEgressPorts]
    ]:
        return typing.cast(
            typing.Optional[
                typing.Union[_cdktf_9a9027ec.IResolvable, NetworkPolicySpecEgressPorts]
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__449e378438bc15c6c545c7ceb39783ee90083440086210c5db0d59afd5b332b3
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecEgressTo:
    def __init__(
        ...
        *,
        ...
        """
        :param ip_block: ip_block block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#ip_block NetworkPolicy#ip_block}
        :param namespace_selector: namespace_selector block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#namespace_selector NetworkPolicy#namespace_selector}
        :param pod_selector: pod_selector block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#pod_selector NetworkPolicy#pod_selector}
        """
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__9596cc154d891d93c3b7d41bd5e984f6daab0e6e177bc1c92a60557f24469d38
            )
            check_type(
    ...
    def namespace_selector(
        ...
        return typing.cast(
            typing.Optional["NetworkPolicySpecEgressToNamespaceSelector"], result
        )
    ...
    def pod_selector(self) -> typing.Optional["NetworkPolicySpecEgressToPodSelector"]:
        ...
        result = self._values.get("pod_selector")
        return typing.cast(
            typing.Optional["NetworkPolicySpecEgressToPodSelector"], result
        )
...
class NetworkPolicySpecEgressToIpBlock:
    def __init__(
        ...
        *,
        ...
        """
        :param cidr: CIDR is a string representing the IP Block Valid examples are "192.168.1.1/24" or "2001:db9::/64". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#cidr NetworkPolicy#cidr}
        :param except_: Except is a slice of CIDRs that should not be included within an IP Block Valid examples are "192.168.1.1/24" or "2001:db9::/64" Except values will be rejected if they are outside the CIDR range. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#except NetworkPolicy#except}
        """
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__1596af371c690fc761b66393eff6c2163fc589ae446be6f93fe52c93e633769f
            )
            check_type(
...
class NetworkPolicySpecEgressToIpBlockOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__c8461a40947cbeb522cde2080e89c10d223e1e28b8799e554d9264df1566d6ea
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def cidr(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__6b6bd13e64d20ac984488ebdd84dfe5598eee6ad1c56944c2cf01b7bcf23a09d
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def except_(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__72396417d42de2fc1a035a3b7195cf90997d6355c6a822707d903cc619f05acb
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(self) -> typing.Optional[NetworkPolicySpecEgressToIpBlock]:
        return typing.cast(
            typing.Optional[NetworkPolicySpecEgressToIpBlock],
            jsii.get(self, "internalValue"),
        )
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__eed3fce4969e33cdda8a638802df279bab678df1fc2f782e4cd86a0ed6dd13fd
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecEgressToList(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__efde1fd9669f10ca3324f7b7a559bd9e37ff59a047a680bb2fd0b0b819e12f55
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def get(self, index: jsii.Number) -> "NetworkPolicySpecEgressToOutputReference":
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__88ba65d43f138df19cc267cb7a4dcdead4a1979764ffaf17dfc582b55990d52a
            )
            check_type(
                argname="argument index", value=index, expected_type=type_hints["index"]
            )
    ...
    def _terraform_attribute(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__a1e53ffdbf047ef1173aad3a964034449b5adb1fa61cabebb8b483cd4913c078
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _terraform_resource(self, value: _cdktf_9a9027ec.IInterpolatingParent) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__565094f49563008142474418d1676c3d39907442e4a6f73682144ec5db30ddab
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _wraps_set(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__d83636edb57cbca1b32409b71ea1ac0e81b1619e0897da5b5df96a260c5d44f4
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__83643c294ec03dd85205bf1479b3461ab1b5bbb27ce2cac8183dc36eea056720
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecEgressToNamespaceSelector:
    def __init__(
        ...
        *,
        ...
        """
        :param match_expressions: match_expressions block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#match_expressions NetworkPolicy#match_expressions}
        :param match_labels: A map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of ``match_expressions``, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#match_labels NetworkPolicy#match_labels}
        """
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__5aa5962224ccf05d3454919b7050fe1aa212339d0bd88309797b0fb4ef90ae2b
            )
            check_type(
    ...
    def match_expressions(
        ...
        typing.Union[
            _cdktf_9a9027ec.IResolvable,
            typing.List["NetworkPolicySpecEgressToNamespaceSelectorMatchExpressions"],
        ]
    ]:
...
class NetworkPolicySpecEgressToNamespaceSelectorMatchExpressions:
    def __init__(
        ...
        *,
        ...
        """
        :param key: The label key that the selector applies to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#key NetworkPolicy#key}
        :param operator: A key's relationship to a set of values. Valid operators ard ``In``, ``NotIn``, ``Exists`` and ``DoesNotExist``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#operator NetworkPolicy#operator}
        :param values: An array of string values. If the operator is ``In`` or ``NotIn``, the values array must be non-empty. If the operator is ``Exists`` or ``DoesNotExist``, the values array must be empty. This array is replaced during a strategic merge patch. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#values NetworkPolicy#values}
        """
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__7a9829bec74c3ac154b9453b2618a6d48920121f6b1f58ad0a6c85624d3aebe8
            )
            check_type(
    ...
    def __repr__(self) -> str:
        return (
            "NetworkPolicySpecEgressToNamespaceSelectorMatchExpressions(%s)"
...
class NetworkPolicySpecEgressToNamespaceSelectorMatchExpressionsList(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__52fa7cff5fed2aa13c7f4ad0ef90761cc13321bf59c4630627930e8bfa239017
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def get(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__8df658552202afaaca0922d981d1a16e6487c8be52980bd2bbf27292415473c1
            )
            check_type(
                argname="argument index", value=index, expected_type=type_hints["index"]
            )
    ...
    def _terraform_attribute(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__0677dc615e4538cd102f9cc7ffcee7958c748a243445a35e751a732e1a24565d
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _terraform_resource(self, value: _cdktf_9a9027ec.IInterpolatingParent) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__ee3bbf4630a03c929237707a6b8891088a515b9a1e0f310a8e2c4e96a3cff22a
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _wraps_set(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__d27faedc5cae363e02403d63da280289ae0a2b7f3f5a2bf84f9e59f841799560
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__906a0abd7ec67a56d6be8dcf937849bc72ec1297b9fe5f086f22132d975cc89a
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecEgressToNamespaceSelectorMatchExpressionsOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__e57f2b014a57e157efef05e4741207c22c85e1839cc8aad9afd7eaba48e6ca77
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def key(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__d2cf2a4d268a8cce2f57998644981cb9e7e2daf24dbc146275983d54a0f4a63f
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def operator(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__9c2bc5a3c007bf5d6362512517152dc9246368dca87a0fc8408e235f520d97a6
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def values(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__98e7cdd88eb617b6cadceff18b5941fc6ee7257107b2b01423fa6c604112b963
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__0fb1f3c686f417e50537988ebdc747c031278182852dc62c0334002864d9d7d4
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecEgressToNamespaceSelectorOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__12223ec209da368814f00b8f69b0285eb4ce79a3b7d3e61c14dc655f727c7a34
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def put_match_expressions(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__b8ca024f2a9608d78ff230ad1c9d3a261fd6e1edf74dc2ad51252a7bda3fd2ea
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def match_labels(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__86218482f406f90b02ee2b43b182d70ce99cbe2507f58060b1af8f2bf20aad67
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__b39f779a6a4cca0264f6a8999f9b89ed4bddcf47bc9bfc148f6440c867214e0d
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecEgressToOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__075f040d4f9f0a0b75309fdb403fddf9f60e337250d6440319792e3ec34e46f7
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def ip_block(self) -> NetworkPolicySpecEgressToIpBlockOutputReference:
        return typing.cast(
            NetworkPolicySpecEgressToIpBlockOutputReference, jsii.get(self, "ipBlock")
        )
    ...
    def internal_value(
        ...
        typing.Union[_cdktf_9a9027ec.IResolvable, NetworkPolicySpecEgressTo]
    ]:
        return typing.cast(
            typing.Optional[
                typing.Union[_cdktf_9a9027ec.IResolvable, NetworkPolicySpecEgressTo]
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__535ea5d4ce56911774be3670ce72ee6351fe2db49f942858a5a6ddf3da7494d1
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecEgressToPodSelector:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__fdbd1adbf28a982c9eb2bad0d0361468a435b7f22415576dc99483256e8a7a40
            )
            check_type(
                argname="argument match_expressions",
                value=match_expressions,
    ...
    def match_expressions(
        ...
        typing.Union[
            _cdktf_9a9027ec.IResolvable,
            typing.List["NetworkPolicySpecEgressToPodSelectorMatchExpressions"],
        ]
    ]:
        """match_expressions block.
...
class NetworkPolicySpecEgressToPodSelectorMatchExpressions:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__29bfdbde4feaad04ff43a9a496ca05d5df28e69d84f8f446533dc8d14da14b88
            )
            check_type(
                argname="argument key", value=key, expected_type=type_hints["key"]
            )
...
class NetworkPolicySpecEgressToPodSelectorMatchExpressionsList(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__b1bb05671114c1c23af56e0e61676875704175dbcc7843e1c22bdc62cf934d50
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def get(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__ad4351a00344c273834c257381261057585ac4d9cef95649772f13cd4cb7f064
            )
            check_type(
                argname="argument index", value=index, expected_type=type_hints["index"]
            )
    ...
    def _terraform_attribute(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__2facecc18191ae084d0e88101ab5ab2c8ad517dbb98f5d1e7e75a7b542b0d161
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _terraform_resource(self, value: _cdktf_9a9027ec.IInterpolatingParent) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__f1aacf56697a83350a6aaf1906b644401aee29242f7dd11c4e3f0b598de7c38e
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _wraps_set(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__cfd7fe8850babfe523db0894a1661127297f431cdf712f15188ee8f3bcb09492
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__324ad173b31cb134720bf3ff8a939d7b02e8d34a9b0cb2f3fb0fe9c95954a21a
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecEgressToPodSelectorMatchExpressionsOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__26ab93a32c311a2057703dfdf834484c93613f1cbc8e6342bdda908b8240fbcd
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def key(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__ed85acd4385488a4036740fcb6ab574783017e0e1268a5ff150cbd193ab0d845
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def operator(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__12293aea1eaa13d77fabb51606655e5b79b967ebddf844559af930fd1f552807
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def values(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__8c2941f191dfc8bdb7cea56702a075cc63c212629c2aa6fea683e752c458910e
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__2fe7c8a581418cc3ffc8a9921f71e16bccf64087cad91ddfe1f649a53065806c
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecEgressToPodSelectorOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__099b4c74c5490c3b51bd04b392a8081254bf6e4d41722216eec1486f103604ce
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def put_match_expressions(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__158ce0f266a08f9d39361e6a9565aa662b1a09dc817221e799f755c0b951f96d
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def match_labels(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__6c89d9634595babfeaa2cebffd0546d07fb1e82defb2fe3d5f65f0ab28c69cbc
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__41dca04f9b4be76424ac7d0729200e84d89de8de86f740648f6df4687a33b00e
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecIngress:
    def __init__(
        ...
        *,
        ...
        """
        :param from_: from block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#from NetworkPolicy#from}
        :param ports: ports block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/network_policy#ports NetworkPolicy#ports}
        """
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__7fa4c17708101b33f3182795bbc7139752c2ca536122d021df4d0412fec5795d
            )
            check_type(
    ...
    def from_(
        ...
        typing.Union[
            _cdktf_9a9027ec.IResolvable, typing.List["NetworkPolicySpecIngressFrom"]
        ]
    ]:
        """from block.
        ...
        return typing.cast(
            typing.Optional[
                typing.Union[
                    _cdktf_9a9027ec.IResolvable,
                    typing.List["NetworkPolicySpecIngressFrom"],
                ]
            ],
            result,
        )
    ...
    def ports(
        ...
        typing.Union[
            _cdktf_9a9027ec.IResolvable, typing.List["NetworkPolicySpecIngressPorts"]
        ]
    ]:
        """ports block.
        ...
        return typing.cast(
            typing.Optional[
                typing.Union[
                    _cdktf_9a9027ec.IResolvable,
                    typing.List["NetworkPolicySpecIngressPorts"],
                ]
            ],
            result,
        )
...
class NetworkPolicySpecIngressFrom:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__146c1b0c7284cabc4cbe00a227ec149d19dfd10d32e5fd02db0dbf15f5876c6c
            )
            check_type(
                argname="argument ip_block",
                value=ip_block,
    ...
    def ip_block(self) -> typing.Optional["NetworkPolicySpecIngressFromIpBlock"]:
        ...
        result = self._values.get("ip_block")
        return typing.cast(
            typing.Optional["NetworkPolicySpecIngressFromIpBlock"], result
        )
    ...
    def namespace_selector(
        ...
        result = self._values.get("namespace_selector")
        return typing.cast(
            typing.Optional["NetworkPolicySpecIngressFromNamespaceSelector"], result
        )
    ...
    def pod_selector(
        ...
        result = self._values.get("pod_selector")
        return typing.cast(
            typing.Optional["NetworkPolicySpecIngressFromPodSelector"], result
        )
...
class NetworkPolicySpecIngressFromIpBlock:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__1a5b01c1aca24cc2d893f8844d21ae7e5ed891dbabb8324efd22e5d6a19906b0
            )
            check_type(
                argname="argument cidr", value=cidr, expected_type=type_hints["cidr"]
            )
...
class NetworkPolicySpecIngressFromIpBlockOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__2d4248d09d767c4cea5312577c952aa749ce71c1cc12949c909fc78c1dc50717
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def cidr(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__10b86ce5b75c9261bc93585d8b3a74a63ef7e76914aacd59d30706741750cea2
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def except_(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__44441cdf53827e5ee5d4effd84faa7caf0fb5e700db5ef0a19f3d4d9c9be09df
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(self) -> typing.Optional[NetworkPolicySpecIngressFromIpBlock]:
        return typing.cast(
            typing.Optional[NetworkPolicySpecIngressFromIpBlock],
            jsii.get(self, "internalValue"),
        )
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__91974dd774ded7db154d45eff3ff95ba564e064456a96d6ae302e36789365846
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecIngressFromList(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__e323fd4485e17705eca22945dc0748b07340fa2a13e485054001bb65378b5290
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def get(self, index: jsii.Number) -> "NetworkPolicySpecIngressFromOutputReference":
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__49ac8ec0a8e1ed2c1ab5e246fa3071da3a97f8742ce0e73833f29181b57a8793
            )
            check_type(
                argname="argument index", value=index, expected_type=type_hints["index"]
            )
    ...
    def _terraform_attribute(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__302a4f8e95e5d051900e39d23c833d24e700e1cea3b5cca5b94523707961d386
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _terraform_resource(self, value: _cdktf_9a9027ec.IInterpolatingParent) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__3adcd8d2e93140c6db8f5a87f7057f3032c46aba58cc1170b68996c8f243106b
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _wraps_set(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__287b761158ce1c43c842768c588eeb529e158662f923db01128b18461c9629d1
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__fc7068a574d045bfab93dcbae194a9b3da874a8a496f6e9653ab13470d4b1f7e
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecIngressFromNamespaceSelector:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__84b9ad6cf4a1753572a9d239661b3fb0101c3fede069551b7a081a2182f4325a
            )
            check_type(
                argname="argument match_expressions",
                value=match_expressions,
...
class NetworkPolicySpecIngressFromNamespaceSelectorMatchExpressions:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__7ecf25a680423466fabdadfc289633f64dc391ffefd4f2ac473a57ffa86f7040
            )
            check_type(
                argname="argument key", value=key, expected_type=type_hints["key"]
            )
    ...
    def __repr__(self) -> str:
        return (
            "NetworkPolicySpecIngressFromNamespaceSelectorMatchExpressions(%s)"
            % ", ".join(k + "=" + repr(v) for k, v in self._values.items())
        )
...
class NetworkPolicySpecIngressFromNamespaceSelectorMatchExpressionsList(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__66a4d6c84acf4b8dba7f23ff50fca98795d62060e73195a7d538c5e9c6904e32
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def get(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__e5663bb14118fffa5b3b47de4ec8a1ceee4f9d0320b7dfdffbeaa7f0813c612a
            )
            check_type(
                argname="argument index", value=index, expected_type=type_hints["index"]
            )
    ...
    def _terraform_attribute(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__618829b2e4ab56a7cc8c73815ca50722009bbb9ade13b1a909217a6806c93645
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _terraform_resource(self, value: _cdktf_9a9027ec.IInterpolatingParent) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__64f860730373f2b3abb256b56c989d9475ec0126170ce009f4bdda60195d60e5
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _wraps_set(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__ff59f9389b0e2d144d6c20d1c73e71093c7254be731cf638b2883970b72079b8
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        typing.Union[
            _cdktf_9a9027ec.IResolvable,
            typing.List[NetworkPolicySpecIngressFromNamespaceSelectorMatchExpressions],
        ]
    ]:
        return typing.cast(
            typing.Optional[
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__2223bb5bfdf1fbb398c68edce0267ed78cb8e97b2cee35eb7859490514cf49e7
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecIngressFromNamespaceSelectorMatchExpressionsOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__9f856bbfa59d349d8af89762ed361058d0250a1452c3c4375edd063a5c6056e8
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def key(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__d59945f1a813fe464bb8a0979a1ae6d4810de8c768ebe31d91a05bae68b0a222
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def operator(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__962ecb13fd74f34cbc15ce692afd91fe469c8ed7dde8f241606e83cd61471e1a
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def values(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__580eaeba73164064f9a3b84a8ea850d153a33b4a1e0d700655bd7b4e8f7d6090
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__daae4cbf323fc514d46182bdff76e9be7e981c383b3b03cf1d3d293f0dae1309
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecIngressFromNamespaceSelectorOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__6b7a5069e31956f0075037a068c25ea0e0c8e865ea432f28961f49c0e78c0d87
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def put_match_expressions(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__683f1a69bb73312c0ce9d84dccbded8859c2298379adae769809164292d2c05d
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def match_labels(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__4591791791f32ef9a5271148975de5be649d5514829f2a4f51e5772ae76bd39d
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__e339211784ec754f0fca3cd14b6f2a5d8d454b69d1699d8daf1201867ad03732
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecIngressFromOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__2779d31cc40d2b368357e718afebb44e226f03bf8655cadcb69883cc50724f4c
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def internal_value(
        ...
        typing.Union[_cdktf_9a9027ec.IResolvable, NetworkPolicySpecIngressFrom]
    ]:
        return typing.cast(
            typing.Optional[
                typing.Union[_cdktf_9a9027ec.IResolvable, NetworkPolicySpecIngressFrom]
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__1618ab19139e435bec6e7490f08c24ad727653f41ce1c0800c89f3ddca121f9e
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecIngressFromPodSelector:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__b469114970af7e26a917568bc61441292b1743c160324d8fd83bf3e9c76e3e60
            )
            check_type(
                argname="argument match_expressions",
                value=match_expressions,
    ...
    def match_expressions(
        ...
        typing.Union[
            _cdktf_9a9027ec.IResolvable,
            typing.List["NetworkPolicySpecIngressFromPodSelectorMatchExpressions"],
        ]
    ]:
        """match_expressions block.
...
class NetworkPolicySpecIngressFromPodSelectorMatchExpressions:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__3ee6f4a0fb2a337b57fe3399f7448b7aa7c8d72fc4fb84c8061ba61e95408ece
            )
            check_type(
                argname="argument key", value=key, expected_type=type_hints["key"]
            )
    ...
    def __repr__(self) -> str:
        return (
            "NetworkPolicySpecIngressFromPodSelectorMatchExpressions(%s)"
            % ", ".join(k + "=" + repr(v) for k, v in self._values.items())
        )
...
class NetworkPolicySpecIngressFromPodSelectorMatchExpressionsList(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__e30d7eba3584936e9b80c5bd55d88d4e878733c2438cc0c030345f126e8c70ca
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def get(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__9e9b3f72e153093ecf8d35841e5e8b600dcc156afee9c41e9d141c0ee2853fed
            )
            check_type(
                argname="argument index", value=index, expected_type=type_hints["index"]
            )
    ...
    def _terraform_attribute(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__b5993bcf731031a4bb5d5ea3c8846c4114ab4e6a8f1885c989bd175439283a0f
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _terraform_resource(self, value: _cdktf_9a9027ec.IInterpolatingParent) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__f756970eea7adf24ad65447e6e8eaa4fbbdd7901c8fdb5fba069c9e174597075
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _wraps_set(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__72981a2a6718138bddaaf230f85654b6e5091a2ad242516b80c4e0a9806d3dcb
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__b77f541fdfa2e1b4efa9227c880a302df5839b2d1c07245ec995f643f9990181
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecIngressFromPodSelectorMatchExpressionsOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__47ff5f37033d76b81aaf0e9f519f17edb4df8fa490219ef830d2973ed7a0be00
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def key(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__31aa214eb5191485f01745edfa6103351d6d7c14a3660d7b924ef1ac7a963a67
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def operator(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__129d45d5dfd0b34371f64154c43de249e3ffb0ee349f03362c121717ae998b08
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def values(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__824b2c9ef84ff58acd0c00f6343a79643f0416bed738923c4cfecdc372793b6c
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__1daf5f49fe9ceb5c50f882494001db3a8b8fc3e6dbb502d00f99011b3532c2f8
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecIngressFromPodSelectorOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__179f6b400698a31220af92a3520e1b67547f6505824118d6eb7273f56b4b79b7
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def put_match_expressions(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__b344db8cbb8b28495ff7a1c0ae90056c655ebd81056b1b13a288e20e8ee80789
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def match_labels(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__3d891e348bc1daac1da2f4ded6924963953f0f0d8602f91f9f5efc30044e7ee6
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__ba06b1d86847110a0407a813187073ea2540750e1b0aecdf299860f1497cbb27
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecIngressList(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__c29792375545cbcc0869a626a34a0a1866801ccb7660b981c5dedddc49522e61
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def get(self, index: jsii.Number) -> "NetworkPolicySpecIngressOutputReference":
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__c22623e79d8d6960156b4fd3c0e39cebbe92aebfcaebd5e436ee7bcfda66d916
            )
            check_type(
                argname="argument index", value=index, expected_type=type_hints["index"]
            )
        return typing.cast(
            "NetworkPolicySpecIngressOutputReference", jsii.invoke(self, "get", [index])
        )
    ...
    def _terraform_attribute(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__7a8282dde7735b36d4f97b9f35a860d535e4df468636be3901e518aa5bdc4524
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _terraform_resource(self, value: _cdktf_9a9027ec.IInterpolatingParent) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__9134397c13b58771c73f462fb81eca670c5415dcd08e66e813341adf9e645539
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _wraps_set(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__cddc6b32e122b925e83572c96ff6d761825ffe37c41bec6058e68cf0c46470e8
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        typing.Union[_cdktf_9a9027ec.IResolvable, typing.List[NetworkPolicySpecIngress]]
    ]:
        return typing.cast(
            typing.Optional[
                typing.Union[
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__d3bbf717641983a05472db47dbc976062ea91d10c3a965be575e2944659bdebf
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecIngressOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__e790563d7af7d41a720b047b622b61643f001826ea0f6f6742d385b9a8dc7917
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def put_from(
        ...
        value: typing.Union[
            ...
            typing.Sequence[
                typing.Union[
                    NetworkPolicySpecIngressFrom, typing.Dict[builtins.str, typing.Any]
                ]
            ],
        ],
    ) -> None:
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__2bd83bf0a2439665882214b420999b12b60192b4e79c225481fdbf4d4ec252f4
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def put_ports(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__ae68e1f592abcadc7aaabaae54997624eb24b928054af1f9fb5ae838a0852bbc
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        typing.Union[_cdktf_9a9027ec.IResolvable, NetworkPolicySpecIngress]
    ]:
        return typing.cast(
            typing.Optional[
                typing.Union[_cdktf_9a9027ec.IResolvable, NetworkPolicySpecIngress]
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__dc3cbcff67fc71fabffd08f2db179aadd46cd27323dd816c5a138c6dc5fd37ee
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecIngressPorts:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__1b5d3c987689ca370fcae19b62907c3d9e0344bbc0292d09954a65b3bf2790a3
            )
            check_type(
                argname="argument port", value=port, expected_type=type_hints["port"]
            )
...
class NetworkPolicySpecIngressPortsList(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__fefd15697d574158a7fb746806ac558e5c67df857e1194ec0b24c9102c69d0cd
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def get(self, index: jsii.Number) -> "NetworkPolicySpecIngressPortsOutputReference":
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__8ce67bf3574bdf90af29c9e50e3c76f4328ad845df5b4643807832b7112ae465
            )
            check_type(
                argname="argument index", value=index, expected_type=type_hints["index"]
            )
    ...
    def _terraform_attribute(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__702c8d5324077be366425bced7fe6b9708b21a76cdd8680e44176610f2433269
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _terraform_resource(self, value: _cdktf_9a9027ec.IInterpolatingParent) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__e9ea814fb10e7ba2258bb84d25da15d696c88f7708a336003a9ee0252971b16b
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _wraps_set(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__bb3d408b4c3143862ffcc1c2528ba5a466f63b4f09cbfc8866003f2a057f01ed
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__dd1ab5cd28faa337d9f6b6d240e094e3408d1f1052f6d529a95a57ef633faa9c
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecIngressPortsOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__0fe74ac4d6c774a7f6582ee0c59079d33cf656ad451c15a1d4027f6db69aa3d2
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def port(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__eb126382c36a0c74e91e6b5d32f133c40f6e7f2089b713fce72dafaa7526cc4d
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def protocol(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__c64ac974fb2dff5759868d5bee3b282d43be337d800b35250d271d48deb1419d
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        typing.Union[_cdktf_9a9027ec.IResolvable, NetworkPolicySpecIngressPorts]
    ]:
        return typing.cast(
            typing.Optional[
                typing.Union[_cdktf_9a9027ec.IResolvable, NetworkPolicySpecIngressPorts]
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__a0cba8b3e94e62b5ddec23348c8cf4c31ebb037e07741f54ad087b402655d8f7
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__9e47415d286c83f2355b0991e15462ebc34daf3a52f6f63752c01346741b8242
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def put_egress(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__bd3fc14e551ce5c38e469fdfb78e078694720128ea82ce59c8317b6838c42e88
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def put_ingress(
        ...
        value: typing.Union[
            ...
            typing.Sequence[
                typing.Union[
                    NetworkPolicySpecIngress, typing.Dict[builtins.str, typing.Any]
                ]
            ],
        ],
    ) -> None:
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__c05d06c8d307075e5dec85c9494e7235556781a59e9005a0abb15b71183205c9
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def pod_selector(self) -> "NetworkPolicySpecPodSelectorOutputReference":
        return typing.cast(
            "NetworkPolicySpecPodSelectorOutputReference", jsii.get(self, "podSelector")
        )
    ...
    def pod_selector_input(self) -> typing.Optional["NetworkPolicySpecPodSelector"]:
        return typing.cast(
            typing.Optional["NetworkPolicySpecPodSelector"],
            jsii.get(self, "podSelectorInput"),
        )
    ...
    def policy_types(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__cd7ace73c9b6c72a492c32de73520df70feb1930830436946d4299a32c607b67
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(self) -> typing.Optional[NetworkPolicySpec]:
        return typing.cast(
            typing.Optional[NetworkPolicySpec], jsii.get(self, "internalValue")
        )
    ...
    def internal_value(self, value: typing.Optional[NetworkPolicySpec]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__723532016c7c75dac113442a13ea9d6e04b3bd9c7abd4b192c5f21aeee04d915
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecPodSelector:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__88a54dba4e6198bc530307eec6123437cb9706d11a93d32d0bbd65a94869ec95
            )
            check_type(
                argname="argument match_expressions",
                value=match_expressions,
    ...
    def match_expressions(
        ...
        typing.Union[
            _cdktf_9a9027ec.IResolvable,
            typing.List["NetworkPolicySpecPodSelectorMatchExpressions"],
        ]
    ]:
        """match_expressions block.
...
class NetworkPolicySpecPodSelectorMatchExpressions:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__08b3180ff78daf3a2b25e3d21f79766dd037088148362d5f0af5ba403dbc9df3
            )
            check_type(
                argname="argument key", value=key, expected_type=type_hints["key"]
            )
...
class NetworkPolicySpecPodSelectorMatchExpressionsList(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__14054831d070520c2459c8417f02646b4013ea9cbb66d7be4ee91e654e047bcf
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def get(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__75a8ae460169eb4d4e24f3057f1e253b2f9181ea3f397ee57101fba81c3ce93b
            )
            check_type(
                argname="argument index", value=index, expected_type=type_hints["index"]
            )
    ...
    def _terraform_attribute(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__abc85ba4c7c3b885d67d48925a0245dce6a4dba54f0a331bfcef9e3edf16e248
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _terraform_resource(self, value: _cdktf_9a9027ec.IInterpolatingParent) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__3fbca86a711f6479a5f82da14593530eceebd5fec4dc89f7c056ae0240f0f826
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def _wraps_set(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__8b6a72d5416844d6f80e534f422c20f7fc7712f5ee63e7712a8c6160ee359616
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__3356bb90130d5f0db283f142e58f2d96cb8e7ad2947cd408ef7beb24d30edf8c
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecPodSelectorMatchExpressionsOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__8c86d6393cb9c24ae5fce7b65414e7e3f6e4951bfbe136ad78f04d6e19d16aa9
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def key(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__f0d28dd6fe628bb9952f7f355f967e20889981f9b95937637f3f77d4735fd130
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def operator(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__2db14dafe92e5893bf7b56bf5c446c511f13178b7aa1b05bf40efb88f4fe99bf
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def values(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__34b05428a8583dfe37bf478228c0a51c4167435a861e7cf17e27a9f4f9d5a7e5
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        typing.Union[
            _cdktf_9a9027ec.IResolvable, NetworkPolicySpecPodSelectorMatchExpressions
        ]
    ]:
        return typing.cast(
            typing.Optional[
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__223968d43b7bd04c6833d5247c6817dd9e4276f042d114e1ea30487730ca5b3e
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class NetworkPolicySpecPodSelectorOutputReference(
    ...
    def __init__(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__46ab5266eab08a108ea4dd03d6246798ce74c4a3685a524bd012878ab34e04de
            )
            check_type(
                argname="argument terraform_resource",
                value=terraform_resource,
    ...
    def put_match_expressions(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__dd0813a257bb06172b0bd66d15a351b747a4f8d0b9ec287b04259759d63178f5
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def match_labels(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__663c405f03851cdff0ffec31234944ac36e65d3a72081b8f26b23a24f0c57492
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__39b203ab5be306bbb7cdd96e12b70b03de004112b8ee30cb5527cf3f015629b1
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
    ...
    *,
    ports: typing.Optional[
        typing.Union[
            ...
            typing.Sequence[
                typing.Union[
                    NetworkPolicySpecEgressPorts, typing.Dict[builtins.str, typing.Any]
                ]
            ],
        ]
    ] = None,
...
def _typecheckingstub__9596cc154d891d93c3b7d41bd5e984f6daab0e6e177bc1c92a60557f24469d38(
    *,
    ip_block: typing.Optional[
        typing.Union[
            NetworkPolicySpecEgressToIpBlock, typing.Dict[builtins.str, typing.Any]
        ]
    ] = None,
    namespace_selector: typing.Optional[
        typing.Union[
    ...
    pod_selector: typing.Optional[
        typing.Union[
            NetworkPolicySpecEgressToPodSelector, typing.Dict[builtins.str, typing.Any]
        ]
    ] = None,
) -> None:
    """Type checking stubs"""
    ...
    *,
    ...
    ports: typing.Optional[
        typing.Union[
            ...
            typing.Sequence[
                typing.Union[
                    NetworkPolicySpecIngressPorts, typing.Dict[builtins.str, typing.Any]
                ]
            ],
        ]
    ] = None,
...
def _typecheckingstub__146c1b0c7284cabc4cbe00a227ec149d19dfd10d32e5fd02db0dbf15f5876c6c(
    *,
    ip_block: typing.Optional[
        typing.Union[
            NetworkPolicySpecIngressFromIpBlock, typing.Dict[builtins.str, typing.Any]
        ]
    ] = None,
    namespace_selector: typing.Optional[
        typing.Union[
...
def _typecheckingstub__bd3fc14e551ce5c38e469fdfb78e078694720128ea82ce59c8317b6838c42e88(
    value: typing.Union[
        _cdktf_9a9027ec.IResolvable,
        typing.Sequence[
            typing.Union[NetworkPolicySpecEgress, typing.Dict[builtins.str, typing.Any]]
        ],
    ],
) -> None:
    """Type checking stubs"""
