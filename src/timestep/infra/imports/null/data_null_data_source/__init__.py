...
class DataNullDataSource(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__993275c77c07c0a6edf6f5d25fb76b835c25edcc8f1a8c8987332347380b9656
            )
            check_type(
    ...
    def has_computed_default_input(self) -> typing.Optional[builtins.str]:
        return typing.cast(
            typing.Optional[builtins.str], jsii.get(self, "hasComputedDefaultInput")
        )
    ...
    def has_computed_default(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__b14c814e8d0b5f2a682d4fbd35cc1b47a64dbbf431f0c9ab991c2a2dcf95655c
            )
            check_type(
    ...
    def inputs(self) -> typing.Mapping[builtins.str, builtins.str]:
        return typing.cast(
            typing.Mapping[builtins.str, builtins.str], jsii.get(self, "inputs")
        )
    ...
    def inputs(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__60e3c75bcdaec110792e58932eb09538a79bfabb7fee159a1fea243dbde3544a
            )
            check_type(
                argname="argument value", value=value, expected_type=type_hints["value"]
            )
...
class DataNullDataSourceConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(
                _typecheckingstub__70ef078514fe90e8735b4449d8177f6005943076f8be09173473fee0603f2757
            )
            check_type(
            ...
            check_type(
                argname="argument has_computed_default",
                value=has_computed_default,
                expected_type=type_hints["has_computed_default"],
            )
            check_type(
                argname="argument inputs",
                value=inputs,
                expected_type=type_hints["inputs"],
            )
