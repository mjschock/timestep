...
from ..deprecated._archive_maps import (
    MAMBA_PRETRAINED_MODEL_ARCHIVE_LIST,  # noqa: F401
)
...
class MambaCache:
    ...
    def __init__(
        self, config: MambaConfig, batch_size: int, dtype: torch.dtype = torch.float16, device: str | None = None
    ):
...
class MambaMixer(nn.Module):
    ...
    def cuda_kernels_forward(self, hidden_states: torch.Tensor, cache_params: MambaCache | None = None):
    ...
    # fmt: off
    def slow_forward(self, input_states, cache_params: MambaCache | None=None):
        ...
        # 4. Final linear projection
        return self.out_proj(scan_output.transpose(1, 2))             # [batch, seq_len, hidden_size]
    # fmt: on

    def forward(self, hidden_states, cache_params: MambaCache | None = None):
...
class MambaForCausalLM(MambaPreTrainedModel):
    ...
    def prepare_inputs_for_generation(
        self, input_ids, cache_params: MambaCache | None = None, inputs_embeds=None, attention_mask=None, **kwargs
    ):
