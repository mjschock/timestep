...
class LlavaNextImageProcessor(BaseImageProcessor):
    ...
    def resize(
        ...
        **kwargs,
        ...
        if "shortest_edge" in size:
            ...
            msg = "Size must contain either 'shortest_edge' or 'height' and 'width'."
    ...
    def _pad_for_patching(
        ...
        return pad(image, padding=((paste_y, paste_y), (paste_x, paste_x)))
    ...
    def get_image_patches(
        ...
        if not isinstance(grid_pinpoints, list):
            msg = "grid_pinpoints must be a list of possible resolutions."
            raise ValueError(msg)
